...
public class MessageInitializer
{
    ...
    public void InitializeMessages()
    {
        ...
        if (chats.Any() && users.Any())
        {
            ...
            // Define sample messages categorized by chat names
            ...
            {
                int messagesToCreate = random.Next(5, 15); // Random number of messages between 5 and 15

                // Start with hello messages
